/*
Ejercicio 25
Llevar un histograma de resultados del evento “tirar un dado”. Un histograma es
...
int main()
{
    ...
    // Lleva a cabo N_LANCES de tiro de dado
    for (i = 0; i < N_LANCES; i++)
    {
        resultado = rand() % N_POSIBLES_VALORES + 1;
        histograma[resultado - 1]++;
    }
